...
@onready var character_label_2: RichTextLabel = %CharacterLabel2
...
func apply_dialogue_line() -> void:
	...
	character_label_2.text = tr(dialogue_line.character, "dialogue")
	
	match character_label.text:
		"Constantine":
			sprite.texture = preload("uid://bpw8c2rma7wl7")
			sprite.region_enabled = true
			sprite.region_rect = Rect2(73.441, 269.002, 922.947, 650.511)
		"Henry":
			sprite.texture = preload("uid://3u8hohbgrn3")
			sprite.region_rect = Rect2(193.4, 100, 624, 706)
